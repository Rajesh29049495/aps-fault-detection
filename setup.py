...
def get_requirements()->List[str]:                          ##this function will return list of strings{the libraries that we have mentioned inside requirement.txt file},and this "->List[str]" is just an annotation given by you as a developer to the other viewers that tjis function will return a list conatining strings, it has no other special function other than this.
